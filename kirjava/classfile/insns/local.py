...
class LoadLocal(Instruction):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<LoadLocal(offset={self.offset}, type={self.type!s}, index={self.index})>"
...
class StoreLocal(Instruction):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<StoreLocal(offset={self.offset}, type={self.type!s}, index={self.index})>"
...
class LoadLocalAt(LoadLocal):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<LoadLocalAt(offset={self.offset}, type={self.type!s}, index={self.index})>"
        return f"<LoadLocalAt(type={self.type!s}, index={self.index})>"

    def __str__(self) -> str:
        if self.offset is not None:
            return f"{self.offset}:{self.mnemonic}({self.index})"
...
class StoreLocalAt(StoreLocal):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<StoreLocalAt(offset={self.offset}, type={self.type!s}, index={self.index})>"
        return f"<StoreLocalAt(type={self.type!s}, index={self.index})>"
...
class IInc(Instruction):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<IInc(offset={self.offset}, index={self.index}, value={self.value})>"
        return f"<IInc(index={self.index}, value={self.value})>"

    def __str__(self) -> str:
        if self.offset is not None:
            return f"{self.offset}:iinc({self.index},{self.value:+})"
...
class LoadLocalAtWide(LoadLocalAt):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<LoadLocalAtWide(offset={self.offset}, type={self.type!s}, index={self.index})>"
...
class StoreLocalAtWide(StoreLocalAt):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<StoreLocalAtWide(offset={self.offset}, index={self.index})>"
...
class IIncWide(IInc):
    ...
    def __repr__(self) -> str:
        if self.offset is not None:
            return f"<IIncWide(offset={self.offset}, index={self.index}, value={self.value})>"
        return f"<IIncWide(index={self.index}, value={self.value})>"

    def __str__(self) -> str:
        if self.offset is not None:
            return f"{self.offset}:iinc_w({self.index},{self.value:+})"
