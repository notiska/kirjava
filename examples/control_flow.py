...
def make_main(control_flow: kirjava.ClassFile) -> None:
    ...
    error_block  = kirjava.analysis.InsnBlock(1)
    invoke_block = kirjava.analysis.InsnBlock(2)
    ...
    error_block.append(kirjava.instructions.getstatic("java/lang/System", "out", "Ljava/io/PrintStream;"))
    error_block.append(kirjava.instructions.ldc(kirjava.constants.String("Please enter 3 or more arguments!")))
    error_block.append(kirjava.instructions.invokevirtual("java/io/PrintStream", "println", "(Ljava/lang/Object;)V"))
    ...
    invoke_block.append(kirjava.instructions.invokestatic("ControlFlow", "testConditionals", "(Ljava/lang/String;)V"))
    ...
    invoke_block.append(kirjava.instructions.aaload())
    invoke_block.append(kirjava.instructions.invokestatic("ControlFlow", "testLoop", "(Ljava/lang/String;Ljava/lang/String;)V"))
...
def make_conditionals(control_flow: kirjava.ClassFile) -> None:
    ...
    doesnt_contain_a = kirjava.analysis.InsnBlock(1)
    length_check     = kirjava.analysis.InsnBlock(2)
    longer_than_5    = kirjava.analysis.InsnBlock(3)
    shorter_than_5   = kirjava.analysis.InsnBlock(4)

    graph.entry_block.append(kirjava.instructions.aload_0())
    graph.entry_block.append(kirjava.instructions.ldc(kirjava.constants.String("a")))
    graph.entry_block.append(kirjava.instructions.invokevirtual("java/lang/String", "contains", "(Ljava/lang/CharSequence;)Z"))
    graph.jump(graph.entry_block, length_check, kirjava.instructions.ifne)
    graph.fallthrough(graph.entry_block, doesnt_contain_a)

    doesnt_contain_a.append(kirjava.instructions.getstatic("java/lang/System", "out", "Ljava/io/PrintStream;"))
    doesnt_contain_a.append(kirjava.instructions.ldc(kirjava.constants.String("First argument doesn't contain 'a' character.")))
    doesnt_contain_a.append(kirjava.instructions.invokevirtual("java/io/PrintStream", "println", "(Ljava/lang/Object;)V"))
    graph.return_(doesnt_contain_a)

    length_check.append(kirjava.instructions.aload_0())
    length_check.append(kirjava.instructions.invokevirtual("java/lang/String", "length", "()I"))
    ...
    longer_than_5.append(kirjava.instructions.getstatic("java/lang/System", "out", "Ljava/io/PrintStream;"))
    longer_than_5.append(kirjava.instructions.ldc(kirjava.constants.String("First argument is 5 characters or longer.")))
    longer_than_5.append(kirjava.instructions.invokevirtual("java/io/PrintStream", "println", "(Ljava/lang/Object;)V"))
    graph.return_(longer_than_5)

    shorter_than_5.append(kirjava.instructions.getstatic("java/lang/System", "out", "Ljava/io/PrintStream;"))
    shorter_than_5.append(kirjava.instructions.ldc(kirjava.constants.String("First argument is shorter than 5 characters.")))
    shorter_than_5.append(kirjava.instructions.invokevirtual("java/io/PrintStream", "println", "(Ljava/lang/Object;)V"))
...
def make_loop(control_flow: kirjava.ClassFile) -> None:
    ...
    exponent_loop_body  = kirjava.analysis.InsnBlock(1)
    result_check        = kirjava.analysis.InsnBlock(2)
    infinite_loop_entry = kirjava.analysis.InsnBlock(3)
    infinite_loop_body  = kirjava.analysis.InsnBlock(4)
    return_block        = kirjava.analysis.InsnBlock(5)

    # Decode the arguments into integers, if possible
    graph.entry_block.append(kirjava.instructions.aload_1())
    graph.entry_block.append(kirjava.instructions.invokestatic("java/lang/Integer", "parseInt", "(Ljava/lang/String;)I"))
    graph.entry_block.append(kirjava.instructions.aload_0())
    graph.entry_block.append(kirjava.instructions.invokestatic("java/lang/Integer", "parseInt", "(Ljava/lang/String;)I"))
    ...
    result_check.append(kirjava.instructions.getstatic("java/lang/System", "out", "Ljava/io/PrintStream;"))
    ...
    result_check.append(kirjava.instructions.anewarray(kirjava.types.object_array_t))
    ...
    result_check.append(kirjava.instructions.invokestatic("java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;"))
    result_check.append(kirjava.instructions.aastore())
    result_check.append(kirjava.instructions.invokestatic("java/lang/String", "format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;"))
    result_check.append(kirjava.instructions.invokevirtual("java/io/PrintStream", "println", "(Ljava/lang/Object;)V"))
    result_check.append(kirjava.instructions.iload_1())
    ...
    infinite_loop_entry.append(kirjava.instructions.getstatic("java/lang/System", "out", "Ljava/io/PrintStream;"))
    ...
    infinite_loop_entry.append(kirjava.instructions.invokevirtual("java/io/PrintStream", "println", "(Ljava/lang/Object;)V"))
