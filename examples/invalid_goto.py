...
if __name__ == "__main__":
    ...
    # Note: we also need to specify handle_jumps=False so that a jump edge is not added for this jump.
    graph.entry_block.add(kirjava.instructions.goto(32767), handle_jumps=False)
